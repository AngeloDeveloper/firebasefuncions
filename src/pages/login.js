/*
convertendo um modelo em bootstrap e jquery para react https://codepen.io/GeBuOr/full/mJJmgx/
        ...
        <div className="logmod__form">
          <form acceptCharset="utf-8" action="#" className="simform">
            ...
            <div className="sminputs">
              ...
              <div className="input string optional">
                <label className="string optional" htmlFor="user-pw-repeat">Repeat password *</label>
      ...
      <div className="logmod__tab lgm-2">
        ...
        <div className="logmod__form">
          <form acceptCharset="utf-8" action="#" className="simform">
            ...
            <div className="simform__actions">
              <input className="sumbit" name="commit" type="sumbit" value="Log In" ></input>
